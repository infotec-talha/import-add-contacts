 <header class="header-dark">
        <nav class="navbar navbar-dark navbar-expand-lg navigation-clean-search">
            <div class="container"><a class="navbar-brand" href="{{route('getIndexPage')}}">CollectPokemon</a><button class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div id="navcol-1" class="collapse navbar-collapse">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link" href="{{route('getCollectionPage')}}">Collections</a></li>
                    ...
                    </form><span class="navbar-text"><a class="login" href="{{route('getLoginPage')}}">Log In</a></span><a class="btn btn-light action-button" role="button" href="{{route('signUpPage')}}" style="background: #cec909;">Sign Up</a>
                </div>
            </div>
        </nav>
    </header>